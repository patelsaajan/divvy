...
const ExpenseDetails = () => {
  ...
  return <div class="px-4 py-6">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <div class="bg-orange-100 p-1 rounded mr-2">
              <span class="text-orange-500 text-xs">Pending</span>
            </div>
            <h2>{expense.title}</h2>
          </div>
        </div>
      ...
      {/* Participants */}
      <div class="mb-6">
        {expense.participants.map(participant => <div key={participant.id} class="bg-gray-800 rounded-lg p-4 mb-2 flex justify-between items-center">
            <div class="flex items-center">
              {participant.avatar ? <img src={participant.avatar} alt={participant.name} class="w-10 h-10 rounded-full mr-3" /> : <div class="w-10 h-10 rounded-full bg-purple-500 flex items-center justify-center mr-3">
      ...
      {/* Expense items */}
      <div class="mb-6">
        {expense.items.map(item => <div key={item.id} class="bg-gray-800 rounded-lg p-4 mb-2 flex justify-between items-center">
            <div class="flex items-center">
              <div class={`w-10 h-10 rounded-full ${item.name.includes('Pizzeria') ? 'bg-teal-500' : 'bg-purple-500'} flex items-center justify-center mr-3`}>
