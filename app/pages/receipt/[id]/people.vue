<template>
    <div class="container mx-auto">
        <UButton variant="ghost" class="flex items-center my-6 cursor-pointer" @click="$router.back()">
     ...
     <div class="mb-6">
        ...
        <div class="flex gap-2 mb-4 w-full">
          ...
          <UButton variant="ghost" class="flex items-center my-6 cursor-pointer" @click="addPerson">
...
const addPerson = () => {
  people.value.push({ id: people.value.length + 1, name: newPerson.value, amount: 0 })
  newPerson.value = ''
}
